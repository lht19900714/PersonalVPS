...
#   Intro:  https://teddysun.com/358.html (not available now)       #
#===================================================================#
...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/lht19900714/PersonalVPS/main/shadowsocks-libev-debian"
}
...
pre_install(){
    ...
    read -p "(Default password: haitao0714):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="haitao0714"
    echo
    echo "---------------------------"
